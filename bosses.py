...
WEAPON_STATS = {
    ...
    "Cuchillo oxidado": {"hit_chance": 0.7, "damage": 15, "crit_chance": 0.15},
    "Pistola vieja": {"hit_chance": 0.75, "damage": 25, "crit_chance": 0.2},
    "Arma blanca artesanal": {"hit_chance": 0.75, "damage": 18, "crit_chance": 0.12},
    "Palo golpeador de parejas felices": {"hit_chance": 0.8, "damage": 22, "crit_chance": 0.1},
    "Savi peluche": {"hit_chance": 0.6, "damage": 12, "crit_chance": 0.3},
    "Aconsejante Fantasma": {"hit_chance": 0.65, "damage": 16, "crit_chance": 0.25},
    "ID falso": {"hit_chance": 0.55, "damage": 8, "crit_chance": 0.35},
    "Máscara de Xfi": {"hit_chance": 0.7, "damage": 20, "crit_chance": 0.18},
    "Bastón de Staff": {"hit_chance": 0.75, "damage": 20, "crit_chance": 0.12},
    "Teléfono": {"hit_chance": 0.45, "damage": 3, "crit_chance": 0.1},
    "Chihuahua": {"hit_chance": 0.5, "damage": 6, "crit_chance": 0.2},
    "Mecha Enojado": {"hit_chance": 0.85, "damage": 28, "crit_chance": 0.25},
    "Linterna": {"hit_chance": 0.4, "damage": 2, "crit_chance": 0.05},
    "Llave Maestra": {"hit_chance": 0.55, "damage": 10, "crit_chance": 0.15},
}
